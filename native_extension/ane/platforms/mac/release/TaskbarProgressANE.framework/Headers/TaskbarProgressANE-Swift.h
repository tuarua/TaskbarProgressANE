...
#import "/Users/User/flash/TaskbarProgressANE/native_library/mac/TaskbarProgressANE/TaskbarProgressANE/TaskbarProgressANE-Bridging-Header.h"

#pragma clang diagnostic ignored "-Wproperty-attribute-mismatch"
#pragma clang diagnostic ignored "-Wduplicate-method-arg"
@class NSCoder;

SWIFT_CLASS("_TtC18TaskbarProgressANE15DockProgressBar")
@interface DockProgressBar : NSProgressIndicator
- (nonnull instancetype)initWithFrame:(NSRect)frameRect style:(NSInteger)style;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)drawRect:(NSRect)dirtyRect;
- (void)updateProgressWithProgress:(double)progress;
- (void)setStyleWithStyle:(NSInteger)style;
...
SWIFT_CLASS("_TtC18TaskbarProgressANE13FREArraySwift")
...
SWIFT_CLASS("_TtC18TaskbarProgressANE18FREBitmapDataSwift")
...
SWIFT_CLASS("_TtC18TaskbarProgressANE17FREByteArraySwift")
...
SWIFT_CLASS("_TtC18TaskbarProgressANE15FREContextSwift")
...
SWIFT_CLASS("_TtC18TaskbarProgressANE14FREObjectSwift")
...
@interface NSObject (SWIFT_EXTENSION(TaskbarProgressANE))
...
SWIFT_CLASS("_TtC18TaskbarProgressANE18TaskbarProgressANE")
@interface TaskbarProgressANE : NSObject
@property (nonatomic, strong) DockProgressBar * _Null_unspecified progress;
- (NSArray<NSString *> * _Nonnull)getFunctions SWIFT_WARN_UNUSED_RESULT;
- (FREObject _Nullable)initControllerWithCtx:(FREContext _Nonnull)ctx argc:(uint32_t)argc argv:(FREObject _Nullable * _Null_unspecified)argv SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
- (FREObject _Nullable)setProgressWithCtx:(FREContext _Nonnull)ctx argc:(uint32_t)argc argv:(FREObject _Nullable * _Null_unspecified)argv SWIFT_WARN_UNUSED_RESULT;
- (FREObject _Nullable)setStyleWithCtx:(FREContext _Nonnull)ctx argc:(uint32_t)argc argv:(FREObject _Nullable * _Null_unspecified)argv SWIFT_WARN_UNUSED_RESULT;
